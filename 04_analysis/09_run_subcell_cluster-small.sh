...
#SBATCH --output=cluster_logs/experiment_%A_%a_small.out
#SBATCH --error=cluster_logs/experiment_%A_%a_small.err
#SBATCH --array=4-7
#SBATCH --mem=300G
...
MORPH_CLASSES=("3" "4")  # remember to do both morph classes "3" and "4"
